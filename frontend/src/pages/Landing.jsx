        ...
        <div className="landing-footer-container">
          <div className="landing-footer-brand-col">
            ...
            <div className="landing-footer-socials">
              <a
                ...
                className="landing-social-btn linkedin"
                aria-label="LinkedIn - Saket Raja"
              >
                <LinkedInIcon size={14} />
                <span>LinkedIn</span>
              </a>
              <a
                href="https://github.com/saketraja26"
                target="_blank"
                rel="noopener noreferrer"
                className="landing-social-btn github"
                aria-label="GitHub - saketraja26"
              >
                <GithubIcon size={14} />
                <span>GitHub</span>
              </a>
          ...
          <div className="landing-footer-nav-col">
            ...
            <ul>
              ...
              <li><span>ML Engineers</span></li>
            </ul>
          </div>
        </div>

        <div className="landing-footer-bottom">
          <p>© {new Date().getFullYear()} CypherCorp AI Studio. Created by Saket Raja. All rights reserved.</p>
